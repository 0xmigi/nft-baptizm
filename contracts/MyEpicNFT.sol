...
contract MyEpicNFT is ERC721URIStorage {
  ...
  uint256 public publicIssued = 0;
    ...
    string[] firstWords = ["Excessive", "Quaint", "Abstract", "Direful", "Erratic", "Puckish", "Conformist", "Soviet", "Alien"];
    string[] secondWords = ["Wet", "Itchy", "Ungraceful", "Slippery", "Sizable", "Exposed", "Legandary", "Flavored"];
    string[] thirdWords = ["Fryingpan", "Spatula", "Mug", "Wok", "Saucepan", "Ladle", "Microwave", "Peeler", "Rag", "Frenchpress"];
